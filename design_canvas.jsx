    ...
    <div
      ...
      <div
        ...
        style={{
          ...
          minHeight: '100%',
          padding: '60px 0 80px', transform: "translate3d(21.5908px, -839.593px, 0px) scale(0.432181)", "--dc-inv-zoom": "2.3138479432698262"
        }}>
...
function DCArtboardFrame({ sectionId, artboard, label, order, onRename, onReorder, onFocus, onDelete }) {
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position: 'relative', flexShrink: 0 }}>
      ...
      style={{ borderRadius: 45, boxShadow: '0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)', overflow: 'hidden', width, height, background: '#fff', ...style }}>
